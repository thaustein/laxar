...
define( [
   ...
   describe( 'A widget module', function() {
      ...
      describe( 'defining an axWidgetArea directive', function() {
         ...
         var CONTROLLER_NAME = 'widgets.portal.test_widget.Controller';
         var $compile;
         var $rootScope;
         var scope;

         beforeEach( function() {
            widgetAreaModule.controller( CONTROLLER_NAME, function( $scope ) { } );
         } );
         ...
         beforeEach( angularMocks.inject( function( _$compile_, _$rootScope_ ) {
            ...
            $rootScope.widgets = {
               ...
               'two': [
                  { id: 2, specification: { name: 'my_widget' },
                     controllerName: CONTROLLER_NAME }
               ]
            };
         ...
         it( 'that sets the correct css class for the widget', function() {
            ...
            expect( element[0].firstChild.className ).toContain( 'my_widget' );
         } );
      ...
      describe( 'defining an axWidgetLoader directive', function() {
         ...
         beforeEach( angularMocks.inject( function( _$timeout_, _$compile_, _$rootScope_, _$httpBackend_, _CssLoader_, EventBus ) {
            ...
            element = $compile( '<div data-ax-widget-loader="widget" id="widget__{{widget.id}}"></div>' )( scope );
            scope.$digest();
            try { $httpBackend.flush(); } catch( e ) { /* OK: cached locally */ }
