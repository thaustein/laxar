...
define( [
   ...
   '../portal_assembler/widget_loader_new',
   '../paths',
   '../timer'
   ...
   module.service( 'portal.PageService', [ function() {
      ...
      return {
         setupPage: function( pageName ) {
            return pageController.setupPage( pageName );
         },
         tearDownPage: function() {
            return pageController.tearDownPage();
         },
   ...
   module.controller( 'portal.PageController', [
      ...
      function( $scope, pageService, $q, configuration, layoutLoader, eventBus, fileResourceProvider, themeManager ) {
         ...
         function assembleDom( layoutInfo ) {
      ...
      return {
         ...
         link: function( scope, element, attrs, controller ) {
            ...
            controller.registerLayoutRenderer( function( layoutInfo ) {
               scope.layoutClass = layoutInfo.layoutClass;
