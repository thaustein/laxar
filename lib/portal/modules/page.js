...
define( [
   ...
   var PAGE_CONTROLLER_SERVICE = 'axPageController';
   /**
    * Manages widget adapters and their DOM for the current page
    */
   module.controller( PAGE_CONTROLLER_SERVICE, [
      ...
      function( $scope, pageService, visibilityService, $q, configuration, layoutLoader, eventBus, fileResourceProvider, themeManager, $timeout ) {
         ...
         var senderOptions = { sender: PAGE_CONTROLLER_SERVICE };
         var subscriberOptions = { subscriber: PAGE_CONTROLLER_SERVICE };
         ...
         function createVisibilityEventManager() {
            var ROOT = '';
            var senderOptions = { sender: PAGE_CONTROLLER_SERVICE, deliverToSender: false };
