...
define( [
   ...
   var VISIBILITY_SERVICE_NAME = 'axVisibilityService';
    ...
    */
   module.factory( VISIBILITY_SERVICE_NAME, [ 'axHeartbeat', function( heartbeat, $rootScope ) {
      ...
      function handlerFor( scope ) {
         ...
         if( !area ) {
            throw new Error( VISIBILITY_SERVICE_NAME + ': could not determine widget area for scope: ' + id );
         }
   ...
   module.controller( PAGE_CONTROLLER_NAME, [
      '$scope', PAGE_SERVICE_NAME, VISIBILITY_SERVICE_NAME, '$q', 'Configuration', 'LayoutLoader', 'EventBus', 'FileResourceProvider', 'ThemeManager', '$timeout',
