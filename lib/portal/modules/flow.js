...
define( [
   ...
   module.controller( 'portal.FlowController', [
      '$window', '$location', '$routeParams', '$rootScope', 'place', 'EventBus', 'ThemeManager', 'PageService',

      function FlowController( $window, $location, $routeParams, $rootScope, place, eventBus, themeManager, pageService ) {
         ...
         eventBus.subscribe( 'navigateRequest', function navigateRequestHandler( event, actions ) {
            ...
            if( newPlace.triggerBrowserReload || event.triggerBrowserReload ) {
               eventBus.publish( 'willNavigate.' + currentTarget_, navigateEvent, eventOptions )
                  .then( function() {
                     return pageService.tearDownPage();
                  } )
                  .then( function() {
            ...
            .then( function() {
               ...
               return pageService.tearDownPage()
                  .then( function() {
                     ...
                     return pageService.setupPage( page );
                  } )
                  .then( function() {
