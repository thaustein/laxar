...
define( [
   ...
   function create( q, fileResourceProvider, eventBus, configuration ) {
      ...
      function load( widgetPath, widgetConfiguration ) {
         ...
         return promise
            .then( function( specification ) {
               ...
               var widgetEventBus = createEventBusForWidget( eventBus, specification );
               var idGenerator = createIdGeneratorForWidget( widgetConfiguration.id );
               var adapter = adapters[ technology ].create( q, fileResourceProvider, widgetEventBus, idGenerator );

               adapter.createController( widgetPath, specification, features, widgetConfiguration, configuration );
               return adapter;
            } );
      }
