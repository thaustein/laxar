...
], function( widgetLoaderModule, portalMocks, fileResourceProvider, log, themeManager ) {
   'use strict';
   ...
   describe( 'An initialized widgetLoader', function() {
      ...
      beforeEach( function() {
         ...
         fileResourceProviderMock_ = {
            provide: jasmine.createSpy( 'fileResourceProvider.provide' ).andCallFake( function( uri ) {
               fileResourceProviderMock_.lastUri = uri;
               return q_.when( widgetSpecification_ );
            } )
         };
      ...
      describe( 'when creating a widget adapter', function() {
         ...
         it( 'will pass the required dependencies', function() {
            ...
            expect( widgetAdapterModuleInput_.specification ).toEqual( widgetSpecification_ );
      ...
      describe( 'when asking a widget adapter to create its controller', function() {
         ...
         it( 'will pass an id generator to the widget instance', function() {
            expect( widgetAdapterMock_.createController ).toHaveBeenCalled();
            expect( widgetAdapterCreateControllerInput_.widgetServices ).toBeDefined();
            expect( widgetAdapterCreateControllerInput_.widgetServices.idGenerator ).toBeDefined();
         } );
      ...
      describe( 'when creating an event bus for a widget controller', function() {
         ...
         describe( 'when a didUpdate event with data attribute is published', function() {
            ...
            it( 'logs this incident in level develop', function() {
      ...
      describe( 'creating an event bus with a didUpdate compatibility layer', function() {
         ...
         describe( 'for widgets that are not json patch compatible', function() {

            beforeEach( function() {
               widgetSpecification_.compatibility = [];
               widgetLoader_.load( widgetConfiguration_ );
               jasmine.Clock.tick( 0 );
               widgetEventBus = widgetAdapterCreateControllerInput_.widgetServices.eventBus;
            ...
            it( 'transforms json patches to updates', function() {
               eventBusMock_.publish( 'didUpdate.resource', {
                  resource: 'resource',
         ...
         describe( 'for widgets that are json patch compatible', function() {
